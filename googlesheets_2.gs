      ...
      switch (type) {
            ...
            for(var x = 0;x<confcheck.length; x++){
              if(userId == confcheck[x][0]){
                ...
                if(confstatus == true){
                  ...
                  var ssx = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1O8iva9bMSPYL8rnFH09WOu_yn68UCxvgItlEjFcciDk/edit#gid=604463474");
                  var sheetx = ssx.getSheetByName("dataemp");
                  ...
                  if(!finded1){
                    var ssx = SpreadsheetApp.openByUrl("https://docs.google.com/spreadsheets/d/1O8iva9bMSPYL8rnFH09WOu_yn68UCxvgItlEjFcciDk/edit#gid=604463474");
                    var sheetx = ssx.getSheetByName("datahotel1");
                  ...
                  if(!finded1 && !finded2){
                    var ssx = SpreadsheetApp.openByUrl("Lhttps://docs.google.com/spreadsheets/d/1O8iva9bMSPYL8rnFH09WOu_yn68UCxvgItlEjFcciDk/edit#gid=604463474");
                    var sheetx = ssx.getSheetByName("datahotel2");
        ...
        case 'follow':
          ...
          if(!already){
            ...
            var admId = "Ua4e359e9754ff2781e6b3df076c6693e";
            var mess = [{
              "type": "flex",
